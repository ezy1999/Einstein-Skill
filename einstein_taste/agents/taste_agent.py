...
Handles user queries about Einstein's likely evaluation of scientific
...
from einstein_taste.config.settings import DEFAULT_CONFIG, ModelConfig, EINSTEIN_PERIODS
from einstein_taste.core.pipeline import TastePipeline


class TasteAgent:
    """
    Interactive agent for Einstein research taste queries.

    Provides a conversational interface for evaluating scientific
    theories/questions against Einstein's documented preferences.
    """
    ...
    def process_query(self, user_input: str) -> str:
        ...
        - Free-form questions about Einstein's taste
        """
    ...
    def get_system_info(self) -> str:
        ...
        return (
            ...
            "Einstein's documented research preferences.\n\n"
            "Query formats:\n"
