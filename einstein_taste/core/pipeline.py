...
from einstein_taste.config.settings import DEFAULT_CONFIG, ModelConfig
from einstein_taste.core.evidence import EvidenceStore
from einstein_taste.core.retriever import EvidenceRetriever
from einstein_taste.core.evaluator import TasteEvaluator
from einstein_taste.core.taste_model import TasteEvaluation, TasteScorer


class TastePipeline:
    """
    End-to-end pipeline for evaluating scientific candidates against
    Einstein's research taste.
    ...
    def format_evaluation(evaluation: TasteEvaluation) -> str:
        ...
        lines = []
        lines.append("=" * 70)
        lines.append("EINSTEIN RESEARCH TASTE EVALUATION")
        lines.append("=" * 70)
