...
Manages historical evidence about Einstein's scientific taste.
Each piece of evidence is tagged with:
- Source type (primary: Einstein's own writings; secondary: scholarly analysis)
- Temporal period (when the evidence applies)
- Relevant taste axes
- Confidence level (how directly the evidence supports a taste dimension)

The system strictly separates what Einstein actually wrote/said from
...
class SourceType(str, Enum):
    """Classification of evidence sources by proximity to Einstein."""
    PRIMARY = "primary"          # Einstein's own papers, letters, lectures
    SECONDARY = "secondary"      # Scholarly analysis of Einstein's work
...
class ConfidenceLevel(str, Enum):
    ...
    DIRECT = "direct"        # Einstein explicitly stated this preference
    STRONG = "strong"        # Clear from Einstein's actions/choices, well-documented
...
class EvidenceRecord(BaseModel):
    """A single piece of historical evidence about Einstein's scientific taste."""
    ...
    is_quote: bool = False  # True if content is a direct quote from Einstein
