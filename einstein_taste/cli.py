...
Command-line interface for the Einstein Research Taste system.
...
from einstein_taste.config.settings import DEFAULT_CONFIG, PROCESSED_DATA_DIR
...
def main():
    ...
    Evaluate scientific theories and questions against Einstein's
...
def rank(candidates: tuple[str, ...], cutoff_year: int, json_output: bool):
    ...
    from einstein_taste.core.pipeline import TastePipeline
    from einstein_taste.utils.formatting import evaluation_to_dict, format_ranking
...
def benchmark(verbose: bool):
    ...
    from einstein_taste.core.pipeline import TastePipeline
    from einstein_taste.evaluation.benchmark import run_benchmark
...
def fetch_data():
    """Fetch historical Einstein data from online sources."""
...
def info():
    ...
    click.echo("Einstein Research Taste System v0.1.0")
