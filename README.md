...
本系统对爱因斯坦的**科研品味（Research Taste）**进行建模——学习他评判理论的标准和偏好，并将这些品味**应用到任何话题上**，包括当代科学和日常决策。

**品味超越时代。** 爱因斯坦没有见过深度学习或量子计算，但他对统一性、简洁性、不变性的追求是永恒的。本系统学习这些品味维度，然后套用到你的问题上。

**应用场景：**
- 科研人员："我这个项目是用xxx做yyy，你怎么看？"
- 科研人员："我遇到xxx问题，有什么合理的科学假设？"
- 日常用户："如果你是爱因斯坦你怎么看这件事？"

**回答格式：先给出自然语言的对话式回答，再给出品味维度的显式评分。** 不是角色扮演，是品味驱动的分析。
